...
class _PlantDetailModalState extends State<_PlantDetailModal> {
  ...
  Widget _buildInfoBar() {
    ...
    final confidence = context.watch<DashboardProvider>().confidenceFor(widget.species.id);
          ...
          final overviewCol = Column(
            ...
            children: [
              Text(speciesOverviewSummary(_detail),
                  style: const TextStyle(fontSize: 13, color: kMu, height: 1.6)),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: 8),
          Text(label, style: const TextStyle(fontSize: 13, color: kMu)),
          const Spacer(),
          Flexible(
            child: Text(value,
      ...
      child: RichText(
        text: TextSpan(
          ...
          children: [
            ...
            TextSpan(
                text: value,
                style: const TextStyle(fontWeight: FontWeight.w500, color: kTx)),
          ],
        ),
      ),
    );
